...
- full `LTX-2.3` BWE audio parity is still pending, and audio-conditioned input, reference-video input, retake, interpolation, one-stage, HQ, and LoRA-driven controls are still tracked separately in the capability matrix
